...
const coordinates = [
    { lat: 45.033915, lon: 38.974063, title: "Перекресток Северная и Красная" },
    { lat: 45.036392, lon: 38.971892, title: "Перекресток Северная и Тургенева" },
    { lat: 45.033124, lon: 38.973567, title: "Перекресток Красная и Октябрьская" },
    { lat: 45.052776, lon: 38.970568, title: "Перекресток Красных Партизан и Гагарина" },
...
function initYandexMap() {
    ...
    ymaps.ready(() => {
        ...
        // Добавляем метки на карту Яндекса без иконок
        coordinates.forEach(coord => {
            const placemark = new ymaps.Placemark([coord.lat, coord.lon], {
                balloonContent: coord.title
            });

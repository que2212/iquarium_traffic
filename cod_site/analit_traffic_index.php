...
<body>
    ...
    <div>
        <div class="head_buttn">
            ...
            <a href="" class="main_buttn">Мониторинг</a>
    ...
    <main>
        <div class="main_top_buttns"><div class="main_mon_buttn">
            <a href="./analit_traffic_index.php">Аналитика Пробок</a>
            <a href="./monit_index.php">Мониторинг Дорог</a>
            <a href="./prognosis_roadworks_index.php">Прогноз Работ</a>
        </div><a href=""><img src="./image/user.png"></a>
        </div>
        </main>
    <footer>

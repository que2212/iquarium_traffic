...
<div class="menu-btn"><img src="./image/menu.png"></div>
    <div class="menu">
        <ul class="menu-list">
            ...
            <ol><a href="./futers.php">Предсказания</a></ol>
            <ol><a href="./requests_index.php">Заявки</a></ol>
        </ul>
        <div class="doc">
                    ...
                    <div class="pan"><div class="panel_buttns">
                        ...
                        <div class="call_buttn">
                            ...
                            <div class="radio">
                                ...
                                <label onclick="alert('Вызов Машины ЦОДД....')" for="color-1">Машина ЦОДД</label>
                            </div>
                            <div class="radio">
                                <input class="custom-radio" type="radio" id="color-2" name="color" value="red">
                                <label onclick="alert('Вызов Машины Полиции....')" for="color-2">Полиция</label>
                            </div>
                            <div class="radio">
                                <input class="custom-radio" type="radio" id="color-4" name="color" value="yellow">
                                <label onclick="alert('Вызов Машины Пожарных....')" for="color-4">Пожарные</label>
                            </div>
                            <div class="radio">
                                <input class="custom-radio" type="radio" id="color-5" name="color" value="green">
                                <label onclick="alert('Вызов Машины Скорая....')" for="color-5">Скорая</label>
                            </div>
